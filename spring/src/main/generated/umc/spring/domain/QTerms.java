...
public class QTerms extends EntityPathBase<Terms> {
    ...
    public final ListPath<umc.spring.domain.mapping.UserTerms, umc.spring.domain.mapping.QUserTerms> memberAgreeList = this.<umc.spring.domain.mapping.UserTerms, umc.spring.domain.mapping.QUserTerms>createList("memberAgreeList", umc.spring.domain.mapping.UserTerms.class, umc.spring.domain.mapping.QUserTerms.class, PathInits.DIRECT2);
